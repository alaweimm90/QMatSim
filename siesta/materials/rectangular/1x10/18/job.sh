...
BandsCond=T
LDOSCond=T
homedir=~/SIESTA/materials/MoS2/Monolayer/rectangular/1x10/18/

if [ "$SOCCond" = "T" ]; then
    scratchFolder=/global/scratch/users/meshal/SIESTA/MoS2/Monolayer/GGA-SOC/rectangular/1x10/18/
    potdir=~/siestapot/GGA-SOC/
else
    scratchFolder=/global/scratch/users/meshal/SIESTA/MoS2/Monolayer/GGA/rectangular/1x10/18/
