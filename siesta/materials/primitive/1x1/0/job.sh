...
BandsCond=T
LDOSCond=T
homedir=~/SIESTA/materials/MoS2/Monolayer/primitive/1x1/0/

if [ "$SOCCond" = "T" ]; then
    scratchFolder=/global/scratch/users/meshal/SIESTA/MoS2/Monolayer/GGA-SOC/primitive/1x1/0/
    potdir=~/siestapot/GGA-SOC/
else
    scratchFolder=/global/scratch/users/meshal/SIESTA/MoS2/Monolayer/GGA/primitive/1x1/0/
